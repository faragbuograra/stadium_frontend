...
import ListStadium from "../Stadium/list";
import ListManager from "../Stadium/listManager";
import ListManger from "../Players/listManger";
    ...
    <>
      ...
      <AppBar position="static">
        ...
        >
          ...
          <Tab label="ملاعبي" {...a11yProps(0)} />
        
          <Tab label="الاعبين" {...a11yProps(1)} />
          <Tab label="مباريات" {...a11yProps(2)} />
        </Tabs>
      </AppBar>
