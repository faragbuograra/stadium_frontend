...
const [totalPages, setTotalPages] = React.useState(0);
  ...
  const loadData = async (page) => {
    try {
      const res = await fetchData(`Admin/match?page=${page}&paginate=${pageSize}`);
      setData(res.data);
  ...
  <div class="relative mx-4 mt-4 overflow-hidden text-slate-700 bg-white rounded-none bg-clip-border">
    <div class="flex items-center justify-between ">
        <div>
            <h3 class="text-lg font-semibold text-slate-800">match List</h3>
            <p class="text-slate-500">Review each match  before edit</p>
        </div>
    ...
    <div data-dialog="dialog"
      ...
      <div class="flex flex-col p-6">
        ...
        <p class="mb-3 mt-1 text-slate-400">
          Enter or reset each information for the Match access.
        </p>
  ...
  { showadd && <div data-dialog-backdrop="dialog" data-dialog-backdrop-close="true" class="absolute left-0 top-0 inset-0 z-[999] grid h-screen w-screen place-items-center bg-black bg-opacity-60 backdrop-blur-sm transition-opacity duration-300">
    <div data-dialog="dialog"
      ...
      <div class="flex flex-col p-6">
        ...
        <p class="mb-3 mt-1 text-slate-400">
          Enter or reset each information for the Match .
        </p>
      ...
      <div class="p-6 pt-0">
        <div class="flex space-x-2">
            ...
            <button
                ...
                onClick={
                    () => {
                        var res = fetchData('admin/Match', '', '', 'POST', 
                        dataAdd
                        );
                        res.then((res) => {
                            console.log(res);
